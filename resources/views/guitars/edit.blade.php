...
<div>
        ...
        <input type="text" value="{{$guitar->name}}" class="text-lg border-1"id="name" name="name" />
        @error('name')
    ...
    <div>
        ...
        <input type="text" value="{{$guitar->brand}}" class="text-lg border-1"id="brand" name="brand" />
        @error('brand')
            <div class="error-message">
                {{$message}}
            </div>
